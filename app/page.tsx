    ...
    <main className="min-h-screen bg-white">
      <nav className="flex items-center justify-between px-8 py-4 border-b border-gray-100">
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="/login" className="text-sm bg-blue-500 text-white px-4 py-2 rounded-lg">get started</a>
        </div>
      </nav>
      ...
      <div className="max-w-2xl mx-auto px-8 pt-24 pb-16 text-center">
        ...
        <a href="/login" className="inline-block bg-blue-500 text-white text-sm font-medium px-8 py-3 rounded-lg">
